...
class UpYun {
	...
	private $bucketname;	//空间名称
	private $username;		//操作员名称
	private $password;		//密码
	private $api_domain = 'v0.api.upyun.com';	//接口的域名
	private $tmp_infos;
	public $timeout = 300;	//设置连接超时时间
	public $debug = false;
	private $content_md5 = null;	//设置待上传文件的 Content-MD5 值
